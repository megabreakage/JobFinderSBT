...
// Public company routes (TODO: Implement CompanyController)
...
// Public HR packages (TODO: Implement HrPackageController)
// Route::get('hr-packages', [HrPackageController::class, 'index']);

// Protected routes with general API rate limiting
Route::middleware(['auth:api', 'throttle:api'])->group(function () {

    // Job Seeker routes (TODO: Implement ProfileController and ApplicationController)
    ...
    // Employer routes (TODO: Implement remaining controllers)
